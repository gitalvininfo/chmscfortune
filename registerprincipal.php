        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Register Principal</li>
                </ul>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <?php
    require 'connection.php';
            $q = $conn->query("SELECT * FROM `tblprincipal` WHERE `principal_id` = '$_GET[id]'") or die(mysqli_error());
            $f1 = $q->fetch_array();
                                    ?>
                                    <h3 class="panel-title">Register Principal</h3>
                                </div>
                                <form id="registrationform" action="crud/registerprincipal.php" method="post" onsubmit="return confirm('Are you sure you want to register this account?');">
                                    <div class="panel-body">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <label>Username</label>
                                                <input type="hidden" class="form-control" name="principal_id" value="<?php echo $_GET['id'];?>" required>
                                    ...
                                    <div class="panel-footer">
                                        <button type="submit" class="btn btn-primary" name="registerprincipal"></span>Register</button>
                                    </div> 
                                </form>                           
                        </div>
