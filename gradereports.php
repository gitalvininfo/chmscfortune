                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php
    require 'connection.php';
            $fetch = $conn->query("SELECT *, count(*) as count FROM `enrollstudent` group by `sy`") or die(mysqli_error());
            $data_points = array();
            while($result = $fetch->fetch_array()){
                $sy = $result['sy'];
                $grade = $result['grade'];
                $count = intval($result['count']);
                $point = array('sy' => $sy, 'grade' => $grade, 'count' => $count);
                array_push($data_points, $point);
            }
            $json_string = json_encode($data_points);
            $file = 'json/gradereports.json';
        ...
        <script src="loadchart/gradereports.js"></script>
